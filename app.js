...
app.get('/contact', csrfProtection, contactController.getContact);
...
app.get('/swipe', csrfProtection, passportConf.isAuthenticated, swipeController.swipe);

/**
 * API examples routes.
 */
app.get('/api', csrfProtection, apiController.getApi);
...
app.post('/api/decision/:id/:decision', passportConf.isAuthenticated, passportConf.isAuthorized, apiController.makeDecision);
